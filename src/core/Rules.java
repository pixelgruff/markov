 ...
 * @param <A>
 */
public interface Rules<S extends State, A extends Action> {
     ...
     * @param action Action taken in origin state
     ...
     * game 
     * @param state Origin State
     * @param player Player whose actions need to be enumerated
     ...
     * @return 
     */
    public double score(final S state, final Player p);
}
