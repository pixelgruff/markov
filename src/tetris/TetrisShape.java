...
public class TetrisShape {
    ...
    public static TetrisShape merge(final TetrisShape shape1, final TetrisShape shape2) {
        ...
        Validate.isFalse(
                shape1.blocks_.stream()
                .anyMatch(block -> shape2.blocks_.contains(block))
        );
        /* Merge the blocks */
        return new TetrisShape(
                Stream.concat(shape1.blocks_.stream(), shape2.blocks_.stream())
                .collect(Collectors.toList())
        );
    }
